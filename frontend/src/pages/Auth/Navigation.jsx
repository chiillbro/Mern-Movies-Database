...
const Navigation = () => {
  ...
  return (
    <div
      className="fixed bottom-10 left-[20rem] transform translate-x-1/2 translate-y-1/2 
      ...
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          <Link
            ...
            transform hover:translate-x-2 ml-[1rem]"
          >
            ...
            {userInfo && (
              <svg
                ...
                className={`h-4 w-4 ml-1 ${
                  dropdownOpen ? "transform rotate-[360deg]" : ""
                }`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="white"
